...
public class StopNameCommandTest {
    ...
    public void testExecute() {
        //when
        new StopNameCommand(panelWriter, panelReader).execute((panelHandler), "stop name");

        //then
        verify(panelWriter).print("<KPT>60$1$stop name</KPT>");
    }
}